...
import {getPublication} from "../../../../store/actions/get.publication";

function PublicationData() {
  const dispatch = useDispatch();
  const prov = useSelector((state: any) => state.prov.data);
  const publication = useSelector((state: any) => state.publication.data);
  ...
  useEffect(() => {
    if (selectedDomainId !== null) {
      dispatch(getPublication(selectedDomainId));
    }
